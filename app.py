...
def save_image(file, folder=None, folder_name="photos"):
    """
    Upload une image vers ImgBB si IMGBB_API_KEY est défini,
    sinon sauvegarde localement (non persistant sur Render).
    Retourne l'URL complète ImgBB ou le filename local.
    """
